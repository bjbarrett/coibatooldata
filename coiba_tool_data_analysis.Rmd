...
To start we can do some preliminary analyses of comparisons between stone tools used by macaques and capuchins. Whicle we do have Nerite snails, we will just compare almendras/sea almonds to beging with.
...
```{r interspecies weight comparison GLM preds, echo=FALSE}
precis(mtc1 , depth=2)
post <- extract.samples(mtc1)
##plot it
...
```{r interspecies weight comparison diam plots, echo=FALSE}
